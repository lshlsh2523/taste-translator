...
export function SearchForm() {
  ...
  return (
    <main className="flex min-h-svh flex-1 flex-col lg:overflow-y-auto">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-10 sm:px-10 lg:px-16 lg:py-8">
        <div className="w-full max-w-[920px]">
          <h1 className="reveal reveal-1 font-headline text-ink text-center text-[2rem] leading-[1.3] font-bold tracking-[-0.01em] sm:text-[2.5rem] lg:text-[2.75rem] xl:text-[3.125rem]">
            어떤 분위기를 가지고 싶으신가요?
          </h1>

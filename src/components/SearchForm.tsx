...
// 원래 12000이었는데, 실제 응답이 그 전에 끝나서 2·3단계 문구가 아예 안
// 보이는 문제가 있었다. 실측해보니 응답이 대부분 20초 안에 끝나서, 3초
// 간격으로 순환시키면 3단계가 다 지나간 뒤에도 결과가 도착할 때까지 계속
// 자연스럽게 순환한다 — 굳이 늘려둘 필요 없이 이대로 유지.
const STAGE_MS = 3000;
